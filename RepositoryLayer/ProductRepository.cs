...
namespace RepositoryLayer
{
    public class ProductRepository
    {
        public static List<Product> GetList()
        {
            ...
            string sql = string.Format(@"SELECT ProductId, ProductName, EanCode, ImageUrl, Price, Length, Width, Height FROM Products;");
        ...
        {
            string sql = string.Format(@"INSERT INTO products(ProductName, EanCode, ImageUrl, Price, Length, Width, Height)
            VALUES('{0}', '{1}', '{2}', {3}, {4}, {5}, {6});Select last_insert_id();",
            product.ProductName, product.EanCode, product.ImageUrl,
            product.Price, product.Length, product.Width, product.Height);
        ...
        public static void Update(Product product)
        {
            ...
            Price={3}, Length={4}, Width={5}, Height={6} WHERE ProductId={7}",
            product.ProductName, product.EanCode,product.ImageUrl, product.Price,
            product.Length, product.Width, product.Height, product.ProductId);
